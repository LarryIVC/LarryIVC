...
# 💫 About Me:
👋 Hi there! I'm a passionate web development student currently enrolled in the Full-Stack Developer program at @Microverse. At Microverse, we embrace the methodology of learning through pair programming and project building to teach the next generation of software developers.<br><br>Originally from Bolivia 🌎, I'm excited about the opportunity to collaborate on challenging projects and learn from other talented developers around the world. I'm open to collaborating on projects and always eager to contribute my skills.<br><br>If you ever find yourself facing technological issues 🤔 or need help with anything related to HTML, CSS, JavaScript, VBA, React, Redux, Ruby, Ruby on Rails, or PostgreSQL, feel free to reach out to me. I'm here to share knowledge and help you find solutions.<br><br>When I'm not coding, you can find me diving into the world of video games 🎮. Fun, happiness, and collaboration are keywords in my approach to life. If you'd like to get in touch with me, don't hesitate to send me an email! [📧](mailto:larry_villegas@hotmail.com)<br><br>I'm excited about what the world of development has in store, and I'm ready to dive into it with enthusiasm and dedication! ⚡
...
| --- | --- |  --- | 
| ![HTML/CSS](https://api.accredible.com/v1/frontend/credential_website_embed_image/certificate/70557153) | ![JavaScript](https://api.accredible.com/v1/frontend/credential_website_embed_image/certificate/72809627) | ![React Redux](https://api.accredible.com/v1/frontend/credential_website_embed_image/certificate/75356034) | 
...
# 📊 GitHub Stats:
![](https://github-readme-stats.vercel.app/api?username=LarryIVC&theme=tokyonight&hide_border=false&include_all_commits=false&count_private=false)<br/>
![](https://github-readme-streak-stats.herokuapp.com/?user=LarryIVC&theme=tokyonight&hide_border=false)<br/>
![](https://github-readme-stats.vercel.app/api/top-langs/?username=LarryIVC&theme=tokyonight&hide_border=false&include_all_commits=false&count_private=false&layout=compact)

## 🏆 GitHub Trophies
![](https://github-profile-trophy.vercel.app/?username=LarryIVC&theme=tokyonight&no-frame=false&no-bg=false&margin-w=4)

---
[![](https://visitcount.itsvg.in/api?id=LarryIVC&icon=5&color=1)](https://visitcount.itsvg.in)
